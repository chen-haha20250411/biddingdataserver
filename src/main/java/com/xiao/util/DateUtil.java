...
public class DateUtil {
    ...
    public static String formatDateTime(String _dateTime, String _format)
        ...
        try {
            ...
            if (!"".equals(strDay)) {
                ...
                if (("01".equals(strMonth)) || ("03".equals(strMonth))
                        || ("05".equals(strMonth)) || ("07".equals(strMonth))
                        || ("08".equals(strMonth)) || ("10".equals(strMonth))
                        || ("12".equals(strMonth))) {
                    if (intDay > 31) {
                        strDay = "31";
                        intDay = 31;
                ...
                if (("02".equals(strMonth)) || ("04".equals(strMonth))
                        || ("06".equals(strMonth)) || ("09".equals(strMonth))
                        || ("11".equals(strMonth))) {
                    if (intDay > 30) {
                        strDay = "30";
                        intDay = 30;
    ...
    public static Date getCurrentDate(String startDay) {
        String formatStyle ="yyyy-MM-dd";
        SimpleDateFormat sdf = new SimpleDateFormat(formatStyle);//"yyyy-MM-dd"
		Date date = null;
		try {
			// 注意格式需要与上面一致，不然会出现异常
     ...
     */
    public static int getYearBetween(String startDay) {
		Date startDate = getCurrentDate(startDay);
    ...
    public static String getMonthBetween(String strDateBegin, String strDateEnd) {
        try {
            ...
            int intMonthEnd;
            String strOut;
            if ("".equals(strDateBegin) || "".equals(strDateEnd)
     ...
     * than, equal to, or greater than str2
     */
    public static int compareDateByDate(String str1, String str2) {
    ...
    public static String getFormattedDate(String strDate, String strFormatTo) {
        ...
        if ("0000-00-00 00:00:00".equals(strDate)
                || "1800-01-01 00:00:00".equals(strDate)) {
            return "";
        }
    ...
    public static String getStringFromString(String strDate) {
        String datastr = "";
        try {
            datastr = sdfLongTimePlus.format(sdfLongTimePlus.parse(strDate));
        } catch (ParseException e) {
        }
        return datastr;
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("==============getStringFromString=" + getStringFromString("2009-11-18 19:14:31.0"));
    ...
    public static int getAgeByDate(String birth) throws Exception {
